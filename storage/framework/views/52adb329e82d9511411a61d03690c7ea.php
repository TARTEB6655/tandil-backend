            ...
            >
                ...
                <div class="sidebar-scroll flex-1 flex flex-col overflow-y-auto overflow-x-hidden min-h-0">
                    <nav class="px-3 py-2" x-data="{ 
                        ...
                        ecommerce: <?php echo e(request()->routeIs('admin.products.*') || request()->routeIs('admin.orders.*') ? 'true' : 'false'); ?>,
                        ...
                        <div class="mb-2">
                            <a href="<?php echo e(route('admin.dashboard')); ?>" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-gray-100' : ''); ?>">
                            ...
                            <ul x-show="userManagement" 
                                ...
                                <li style="padding-left: 20px;">
                                    <a href="<?php echo e(route('admin.users.index')); ?>" 
                                       class="flex items-center gap-2.5 rounded-md pl-7 pr-3 py-1.5 text-sm font-normal text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors <?php echo e(request()->routeIs('admin.users.*') ? 'bg-gray-100 text-gray-900' : ''); ?>">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                                        </svg>
                                        Users
                                ...
                                <li style="padding-left: 20px;">
                                    <a href="<?php echo e(route('admin.roles.index')); ?>" 
                                       class="flex items-center gap-2.5 rounded-md pl-7 pr-3 py-1.5 text-sm font-normal text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors <?php echo e(request()->routeIs('admin.roles.*') ? 'bg-gray-100 text-gray-900' : ''); ?>">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <ul x-show="subscriptions" 
                                ...
                                <li style="padding-left: 20px;">
                                    <a href="<?php echo e(route('admin.subscription-plans.index')); ?>" 
                                       class="flex items-center gap-2.5 rounded-md pl-7 pr-3 py-1.5 text-sm font-normal text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors <?php echo e(request()->routeIs('admin.subscription-plans.*') ? 'bg-gray-100 text-gray-900' : ''); ?>">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <li style="padding-left: 20px;">
                                    <a href="<?php echo e(route('admin.subscriptions.index')); ?>" 
                                       class="flex items-center gap-2.5 rounded-md pl-7 pr-3 py-1.5 text-sm font-normal text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors <?php echo e(request()->routeIs('admin.subscriptions.*') ? 'bg-gray-100 text-gray-900' : ''); ?>">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        All Subscriptions
                            ...
                            <ul x-show="operations" 
                                ...
                                <li style="padding-left: 20px;">
                                    <a href="<?php echo e(route('admin.visits.index')); ?>" 
                                       class="flex items-center gap-2.5 rounded-md pl-7 pr-3 py-1.5 text-sm font-normal text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors <?php echo e(request()->routeIs('admin.visits.*') ? 'bg-gray-100 text-gray-900' : ''); ?>">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <li style="padding-left: 20px;">
                                    <a href="<?php echo e(route('admin.reports.index')); ?>" 
                                       class="flex items-center gap-2.5 rounded-md pl-7 pr-3 py-1.5 text-sm font-normal text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors <?php echo e(request()->routeIs('admin.reports.*') ? 'bg-gray-100 text-gray-900' : ''); ?>">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                        </svg>
                                        Reports
                                ...
                                <li style="padding-left: 20px;">
                                    <a href="<?php echo e(route('admin.areas.index')); ?>" 
                                       class="flex items-center gap-2.5 rounded-md pl-7 pr-3 py-1.5 text-sm font-normal text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors <?php echo e(request()->routeIs('admin.areas.*') ? 'bg-gray-100 text-gray-900' : ''); ?>">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <ul x-show="ecommerce" 
                                ...
                                <li style="padding-left: 20px;">
                                    <a href="<?php echo e(route('admin.products.index')); ?>" 
                                       class="flex items-center gap-2.5 rounded-md pl-7 pr-3 py-1.5 text-sm font-normal text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors <?php echo e(request()->routeIs('admin.products.*') ? 'bg-gray-100 text-gray-900' : ''); ?>">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <li style="padding-left: 20px;">
                                    <a href="<?php echo e(route('admin.orders.index')); ?>" 
                                       class="flex items-center gap-2.5 rounded-md pl-7 pr-3 py-1.5 text-sm font-normal text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors <?php echo e(request()->routeIs('admin.orders.*') ? 'bg-gray-100 text-gray-900' : ''); ?>">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                                        </svg>
                                        Orders
                            ...
                            <ul x-show="communication" 
                                ...
                                <li style="padding-left: 20px;">
                                    <a href="<?php echo e(route('admin.tips.index')); ?>" 
                                       class="flex items-center gap-2.5 rounded-md pl-7 pr-3 py-1.5 text-sm font-normal text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors <?php echo e(request()->routeIs('admin.tips.*') ? 'bg-gray-100 text-gray-900' : ''); ?>">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <li style="padding-left: 20px;">
                                    <a href="<?php echo e(route('admin.complaints.index')); ?>" 
                                       class="flex items-center gap-2.5 rounded-md pl-7 pr-3 py-1.5 text-sm font-normal text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors <?php echo e(request()->routeIs('admin.complaints.*') ? 'bg-gray-100 text-gray-900' : ''); ?>">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <ul x-show="management" 
                                ...
                                <li style="padding-left: 20px;">
                                    <a href="<?php echo e(route('admin.hr.index')); ?>" 
                                       class="flex items-center gap-2.5 rounded-md pl-7 pr-3 py-1.5 text-sm font-normal text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors <?php echo e(request()->routeIs('admin.hr.*') ? 'bg-gray-100 text-gray-900' : ''); ?>">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                        </svg>
                                        Technicians
                                ...
                                <li style="padding-left: 20px;">
                                    <a href="<?php echo e(route('admin.audit-logs.index')); ?>" 
                                       class="flex items-center gap-2.5 rounded-md pl-7 pr-3 py-1.5 text-sm font-normal text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors <?php echo e(request()->routeIs('admin.audit-logs.*') ? 'bg-gray-100 text-gray-900' : ''); ?>">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                        </svg>
                                        Audit Logs
                                ...
                                <li style="padding-left: 20px;">
                                    <a href="<?php echo e(route('admin.banners.index')); ?>" 
                                       class="flex items-center gap-2.5 rounded-md pl-7 pr-3 py-1.5 text-sm font-normal text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors <?php echo e(request()->routeIs('admin.banners.*') ? 'bg-gray-100 text-gray-900' : ''); ?>">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
