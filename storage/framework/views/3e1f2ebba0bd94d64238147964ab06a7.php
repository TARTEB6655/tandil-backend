...
<?php $component->withAttributes([]); ?>
    <div class="space-y-6">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            <form method="POST" action="<?php echo e(route('admin.banners.update', $id ?? 1)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\projects\tandil-backend\resources\views\admin\banners\edit.blade.php ENDPATH**/ ?>