...
<?php $component->withAttributes([]); ?>
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            <form method="POST" action="<?php echo e(route('admin.settings.app')); ?>" enctype="multipart/form-data" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        <?php if($logo): ?>
                            <img src="<?php echo e(asset('storage/' . $logo)); ?>" alt="Logo" class="h-20 w-auto object-contain border border-gray-200 rounded-lg p-2">
                        <?php endif; ?>
                        <div class="flex-1">
                            <input type="file" 
                                   id="logo" 
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            <input type="color" 
                                   ...
                                   value="<?php echo e($secondaryColor); ?>"
                                   class="h-10 w-20 rounded border border-gray-300 cursor-pointer">
                            <input type="text" 
                                   value="<?php echo e($secondaryColor); ?>"
                                   class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            <form method="POST" action="<?php echo e(route('admin.settings.contact')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="email" 
                               id="contact_email" 
                               name="contact_email" 
                               value="<?php echo e(Setting::get('contact_email')); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    <div>
                        ...
                        <input type="text" 
                               id="contact_phone" 
                               name="contact_phone" 
                               value="<?php echo e(Setting::get('contact_phone')); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                </div>
                <div>
                    ...
                    <textarea id="contact_address" 
                              ...
                              rows="3"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(Setting::get('contact_address')); ?></textarea>
                </div>
                <button type="submit" class="px-6 py-2.5 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors font-medium">
                    Save Contact Info
                </button>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            <form method="POST" action="<?php echo e(route('admin.settings.social')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="url" 
                               id="facebook_url" 
                               name="facebook_url" 
                               value="<?php echo e(Setting::get('facebook_url')); ?>"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               id="twitter_url" 
                               name="twitter_url" 
                               value="<?php echo e(Setting::get('twitter_url')); ?>"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               id="instagram_url" 
                               name="instagram_url" 
                               value="<?php echo e(Setting::get('instagram_url')); ?>"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               id="linkedin_url" 
                               name="linkedin_url" 
                               value="<?php echo e(Setting::get('linkedin_url')); ?>"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               id="youtube_url" 
                               name="youtube_url" 
                               value="<?php echo e(Setting::get('youtube_url')); ?>"
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            <form method="POST" action="<?php echo e(route('admin.settings.payment')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <select id="payment_gateway" 
                            ...
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                            required>
                        <option value="stripe" <?php echo e(Setting::get('payment_gateway') === 'stripe' ? 'selected' : ''); ?>>Stripe</option>
                        <option value="paymob" <?php echo e(Setting::get('payment_gateway') === 'paymob' ? 'selected' : ''); ?>>PayMob</option>
                        <option value="ccavenue" <?php echo e(Setting::get('payment_gateway') === 'ccavenue' ? 'selected' : ''); ?>>CCAvenue</option>
                        <option value="tap" <?php echo e(Setting::get('payment_gateway') === 'tap' ? 'selected' : ''); ?>>Tap Payments</option>
                    </select>
                </div>
                <div>
                    ...
                    <input type="text" 
                           id="api_key" 
                           name="api_key" 
                           value="<?php echo e(Setting::get('payment_api_key')); ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                           required>
                </div>
                <div>
                    ...
                    <input type="password" 
                           id="api_secret" 
                           name="api_secret" 
                           value="<?php echo e(Setting::get('payment_api_secret')); ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                           required>
                </div>
                <button type="submit" class="px-6 py-2.5 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors font-medium">
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            <form method="POST" action="<?php echo e(route('admin.settings.email')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" 
                               id="smtp_host" 
                               name="smtp_host" 
                               value="<?php echo e(Setting::get('smtp_host', 'smtp.gmail.com')); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                               required>
                    </div>
                    <div>
                        ...
                        <input type="number" 
                               id="smtp_port" 
                               name="smtp_port" 
                               value="<?php echo e(Setting::get('smtp_port', '587')); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                               required>
                    </div>
                    <div>
                        ...
                        <input type="text" 
                               id="smtp_username" 
                               name="smtp_username" 
                               value="<?php echo e(Setting::get('smtp_username')); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                               required>
                    </div>
                    <div>
                        ...
                        <input type="password" 
                               id="smtp_password" 
                               name="smtp_password" 
                               value="<?php echo e(Setting::get('smtp_password')); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                               required>
                    </div>
                    <div>
                        ...
                        <select id="smtp_encryption" 
                                ...
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                required>
                            <option value="tls" <?php echo e(Setting::get('smtp_encryption') === 'tls' ? 'selected' : ''); ?>>TLS</option>
                            <option value="ssl" <?php echo e(Setting::get('smtp_encryption') === 'ssl' ? 'selected' : ''); ?>>SSL</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <input type="email" 
                               ...
                               value="<?php echo e(Setting::get('smtp_from_email')); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                               required>
                    </div>
                    <div>
                        ...
                        <input type="text" 
                               id="smtp_from_name" 
                               name="smtp_from_name" 
                               value="<?php echo e(Setting::get('smtp_from_name', $appName)); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                               required>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            <form method="POST" action="<?php echo e(route('admin.settings.notification')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="<?php echo e(Setting::get('firebase_server_key')); ?>"
                           placeholder="AAAA..."
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="<?php echo e(Setting::get('firebase_sender_id')); ?>"
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            <form method="POST" action="<?php echo e(route('admin.settings.security')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   value="<?php echo e(Setting::get('password_min_length', 8)); ?>"
                                   min="6" max="32"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div class="space-y-2">
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       <?php echo e(Setting::get('password_require_uppercase', false) ? 'checked' : ''); ?>
                            ...
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       <?php echo e(Setting::get('password_require_lowercase', false) ? 'checked' : ''); ?>
                            ...
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       <?php echo e(Setting::get('password_require_numbers', false) ? 'checked' : ''); ?>
                            ...
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       <?php echo e(Setting::get('password_require_symbols', false) ? 'checked' : ''); ?>
                ...
                <div class="pt-4 border-t border-gray-200">
                    ...
                    <label class="flex items-center">
                        <input type="checkbox" 
                               ...
                               value="1"
                               <?php echo e(Setting::get('two_factor_enabled', false) ? 'checked' : ''); ?>
                ...
                <div class="pt-4 border-t border-gray-200">
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               value="<?php echo e(Setting::get('login_attempts_limit', 5)); ?>"
                               min="3" max="10"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            <form method="POST" action="<?php echo e(route('admin.settings.integrations')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   value="<?php echo e(Setting::get('whatsapp_api_key')); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   value="<?php echo e(Setting::get('whatsapp_phone_number')); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="pt-4 border-t border-gray-200">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               value="<?php echo e(Setting::get('google_maps_api_key')); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                </div>
                ...
                <div class="pt-4 border-t border-gray-200">
                    ...
                    <div>
                        ...
                        <input type="url" 
                               id="webhook_url" 
                               name="webhook_url" 
                               value="<?php echo e(Setting::get('webhook_url')); ?>"
...
<?php endif; ?>
<?php /**PATH C:\projects\tandil-backend\resources\views\admin\settings\index.blade.php ENDPATH**/ ?>