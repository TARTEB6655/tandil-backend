        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 md:p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
            <div class="flex items-center justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-2xl md:text-3xl font-bold text-gray-900"><?php echo e(number_format($totalUsers ?? 0)); ?></p>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 md:p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
            <div class="flex items-center justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-2xl md:text-3xl font-bold text-gray-900"><?php echo e(number_format($activeSubscriptions ?? 0)); ?></p>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 md:p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
            <div class="flex items-center justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-2xl md:text-3xl font-bold text-gray-900">AED <?php echo e(number_format($totalRevenue ?? 0)); ?></p>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 md:p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
            <div class="flex items-center justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-2xl md:text-3xl font-bold text-gray-900"><?php echo e(number_format($totalOrders ?? 0)); ?></p>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4 md:p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl md:text-2xl font-bold text-gray-900"><?php echo e($visitsToday ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4 md:p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl md:text-2xl font-bold text-gray-900"><?php echo e($pendingComplaints ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4 md:p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl md:text-2xl font-bold text-gray-900"><?php echo e($pendingReports ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4 md:p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl md:text-2xl font-bold text-gray-900"><?php echo e($activeRegions ?? 0); ?></p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 md:p-6 shadow-sm">
            <div class="mb-4 md:mb-6 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('admin.users.index')); ?>" class="text-sm text-blue-600 hover:text-blue-700 font-medium">View all</a>
            </div>
            <div class="space-y-3">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 md:p-6 shadow-sm">
            <div class="mb-4 md:mb-6 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-sm text-blue-600 hover:text-blue-700 font-medium">View all</a>
            </div>
            <div class="space-y-3">
                <?php $__empty_1 = true; $__currentLoopData = ($recentOrders ?? collect())->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors">
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-900 truncate">Order #<?php echo e($order->id ?? 'N/A'); ?></p>
                            <p class="text-xs text-gray-500">AED <?php echo e(number_format($order->total_amount ?? 0, 2)); ?></p>
                        </div>
                        <span class="ml-3 inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                            <?php echo e(ucfirst($order->order_status ?? 'Pending')); ?>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 md:p-6 shadow-sm">
            <div class="mb-4 md:mb-6 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('admin.complaints.index')); ?>" class="text-sm text-blue-600 hover:text-blue-700 font-medium">View all</a>
            </div>
            <div class="space-y-3">
                <?php
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentComplaints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $complaint): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors">
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-900 truncate"><?php echo e(Str::limit($complaint->subject ?? 'No subject', 30)); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e($complaint->created_at->diffForHumans() ?? 'Recently'); ?></p>
                        </div>
                        <span class="ml-3 inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($complaint->status === 'pending' ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800'); ?>">
                            <?php echo e(ucfirst($complaint->status ?? 'Pending')); ?>
