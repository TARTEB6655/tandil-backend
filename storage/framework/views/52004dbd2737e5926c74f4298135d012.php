<div class="relative" x-data="{ open: false }">
    ...
    >
        ...
        <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
...
<?php /**PATH C:\projects\tandil-backend\resources\views\components\nav-user-dropdown.blade.php ENDPATH**/ ?>