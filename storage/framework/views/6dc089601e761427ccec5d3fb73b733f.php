    ...
    <div class="space-y-4 sm:space-y-6">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <?php if($unreadCount > 0): ?>
                        <form method="POST" action="<?php echo e(route('admin.notifications.mark-all-read')); ?>" class="flex-shrink-0">
                            <?php echo csrf_field(); ?>
                            <button type="submit" 
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-lg font-medium text-gray-900"><?php echo e($notifications->total()); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-lg font-medium text-red-600"><?php echo e($unreadCount); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-lg font-medium text-gray-600"><?php echo e($notifications->total() - $unreadCount); ?></p>
                    </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="border-b border-gray-100 last:border-b-0 hover:bg-gray-50 transition-colors duration-150 <?php echo e($notification->read_at ? '' : 'bg-blue-50/30'); ?>">
                    <div class="px-5 py-4">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-shrink-0 mt-0.5">
                                ...
                                ?>
                                <div class="h-10 w-10 rounded-full <?php echo e($iconBg); ?> <?php echo e($iconBorder); ?> border flex items-center justify-center">
                                    <?php if(str_contains($type, 'Order')): ?>
                                        <svg class="w-5 h-5 <?php echo e($iconColorClass); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                ...
                                <div class="flex items-start justify-between gap-3">
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <?php if(isset($data['visit_id'])): ?>
                                            <p class="text-xs text-gray-600 mb-1">Visit ID: #<?php echo e($data['visit_id']); ?></p>
                                        <?php endif; ?>
                                        <?php if(isset($data['subscription_id'])): ?>
                                            <p class="text-xs text-gray-600 mb-1">Subscription ID: #<?php echo e($data['subscription_id']); ?></p>
                                        <?php endif; ?>
                                        <?php if(isset($data['order_id'])): ?>
                                            <p class="text-xs text-gray-600 mb-1">Order ID: #<?php echo e($data['order_id']); ?></p>
                                        <?php endif; ?>
                                    ...
                                    <div class="flex items-center gap-2 flex-shrink-0">
                                        ...
                                        <div class="flex items-center gap-1">
                                            <?php if(!$notification->read_at): ?>
                                                <form method="POST" action="<?php echo e(route('admin.notifications.mark-as-read', $notification->id)); ?>" class="inline">
                                                    <?php echo csrf_field(); ?>
                                                    <button type="submit" 
                                            ...
                                            <?php endif; ?>
                                            <form method="POST" action="<?php echo e(route('admin.notifications.destroy', $notification->id)); ?>" class="inline" onsubmit="return confirm('Are you sure you want to delete this notification?');">
                                                <?php echo csrf_field(); ?>
