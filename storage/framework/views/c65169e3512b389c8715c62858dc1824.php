    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            ...
            <div class="flex items-center gap-3 flex-wrap">
                ...
                <a href="<?php echo e(route('admin.products.import')); ?>" 
                   class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 transition-colors">
                    Import
                </a>
            ...
            <div class="flex items-center justify-between px-4 py-3 border-b border-gray-200">
                <div class="flex items-center gap-1 overflow-x-auto">
                    <a href="<?php echo e(route('admin.products.index')); ?>" 
                       class="px-4 py-2 text-sm font-medium <?php echo e(!request('filter') ? 'text-gray-900 border-b-2 border-gray-900' : 'text-gray-600 hover:text-gray-900'); ?> whitespace-nowrap">
                        All
                    </a>
                    <a href="<?php echo e(route('admin.products.index', ['filter' => 'active'])); ?>" 
                       class="px-4 py-2 text-sm font-medium <?php echo e(request('filter') == 'active' ? 'text-gray-900 border-b-2 border-gray-900' : 'text-gray-600 hover:text-gray-900'); ?> whitespace-nowrap">
                        Active
                    </a>
                    <a href="<?php echo e(route('admin.products.index', ['filter' => 'draft'])); ?>" 
                       class="px-4 py-2 text-sm font-medium <?php echo e(request('filter') == 'draft' ? 'text-gray-900 border-b-2 border-gray-900' : 'text-gray-600 hover:text-gray-900'); ?> whitespace-nowrap">
                        Draft
                    </a>
                    <a href="<?php echo e(route('admin.products.index', ['filter' => 'archived'])); ?>" 
                       class="px-4 py-2 text-sm font-medium <?php echo e(request('filter') == 'archived' ? 'text-gray-900 border-b-2 border-gray-900' : 'text-gray-600 hover:text-gray-900'); ?> whitespace-nowrap">
                        Archived
                    </a>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition-colors cursor-pointer" onclick="window.location='<?php echo e(route('admin.products.show', $product)); ?>'">
                                ...
                                <td class="px-4 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                        <?php echo e(($product->stock > 0 && !request('filter')) || request('filter') == 'active' ? 'bg-green-100 text-green-800' : 
                                           (request('filter') == 'draft' ? 'bg-gray-100 text-gray-800' : 
                                           (request('filter') == 'archived' ? 'bg-gray-100 text-gray-800' : 'bg-red-100 text-red-800'))); ?>">
                                        <?php echo e(($product->stock > 0 && !request('filter')) || request('filter') == 'active' ? 'Active' : 
                                ...
                                <td class="px-4 py-4 whitespace-nowrap text-right text-sm font-medium" onclick="event.stopPropagation()">
                                    <div class="flex items-center justify-end gap-2">
                                        <form method="POST" action="<?php echo e(route('admin.products.toggle-status', $product->id)); ?>" class="inline">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" 
                                                    class="text-xs px-2 py-1 rounded <?php echo e($product->status === 'active' ? 'bg-green-100 text-green-700 hover:bg-green-200' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?> transition-colors">
                                                <?php echo e($product->status === 'active' ? 'Published' : 'Unpublished'); ?>
