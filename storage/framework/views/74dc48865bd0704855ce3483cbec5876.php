...
<?php $component->withAttributes([]); ?>
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-xl font-medium text-gray-900">Create Category</h1>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea id="description" 
                              name="description" 
                              rows="4"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('description')); ?></textarea>
...
<?php /**PATH C:\projects\tandil-backend\resources\views\admin\categories\create.blade.php ENDPATH**/ ?>