                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4 min-w-0 flex-1">
                                            <div class="text-sm font-medium text-gray-900 truncate"><?php echo e($user->name); ?></div>
                                            <div class="text-xs text-gray-500 sm:hidden mt-0.5 truncate"><?php echo e($user->email); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-600 hidden sm:table-cell"><?php echo e($user->email); ?></td>
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-600 hidden md:table-cell"><?php echo e($user->phone ?? 'N/A'); ?></td>
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium <?php echo e($user->status == 'active' ? 'bg-gray-100 text-gray-700' : 'bg-gray-200 text-gray-600'); ?>">
                                        <span class="w-1.5 h-1.5 rounded-full mr-1.5 <?php echo e($user->status == 'active' ? 'bg-gray-600' : 'bg-gray-400'); ?>"></span>
...
<?php endif; ?>
<?php /**PATH C:\projects\tandil-backend\resources\views/admin/users/index.blade.php ENDPATH**/ ?>