...
<?php $component->withAttributes([]); ?>
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-tr from-green-50 to-green-100 dark:from-gray-900 dark:to-gray-800 px-4">
        <div class="bg-white dark:bg-gray-900 shadow-lg rounded-lg max-w-lg w-full p-10 text-center transform transition duration-500 ease-in-out hover:scale-[1.02]">
            ...
            <a href="<?php echo e(route('profile.edit')); ?>" class="inline-block bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-3 rounded-lg shadow-md transition duration-300 animate-fadeIn delay-300">
                Manage Profile
            </a>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\projects\tandil-backend\resources\views\home.blade.php ENDPATH**/ ?>