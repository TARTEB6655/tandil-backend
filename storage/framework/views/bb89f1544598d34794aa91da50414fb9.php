...
<?php $component->withAttributes([]); ?>
    <div class="space-y-4 sm:space-y-6">
        ...
        <div class="mb-6 md:mb-8">
            <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Roles & Permissions</h1>
            <p class="mt-1 text-sm md:text-base text-gray-600">Manage user roles and their permissions</p>
        </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4 min-w-0 flex-1">
                                            <div class="text-sm font-semibold text-gray-900 truncate"><?php echo e(ucfirst(str_replace('_', ' ', $role->name))); ?></div>
                                            <div class="text-xs text-gray-500 mt-0.5 truncate hidden sm:block"><?php echo e($role->name); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-gray-100 text-gray-700">
                                        ...
                                        <?php echo e($role->users_count ?? 0); ?> <?php echo e(Str::plural('user', $role->users_count ?? 0)); ?>
                                        ...
                                        <?php if($role->permissions && $role->permissions->count() > 0): ?>
                                            <?php $__currentLoopData = $role->permissions->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-100 text-gray-700">
                                                    <?php echo e(Str::limit($permission->name, 20)); ?>
...
<?php endif; ?>
<?php /**PATH C:\projects\tandil-backend\resources\views/admin/roles/index.blade.php ENDPATH**/ ?>