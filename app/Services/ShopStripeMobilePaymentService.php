...
class ShopStripeMobilePaymentService
{
            ...
            try {
                $order = DB::transaction(function () use (
                    ...
                    $row = new ShopMobileCheckout([
                        ...
                        'instant_order_fee' => (float) ($summary['instant_order_fee'] ?? 0),
                        'total_amount' => $total,
    ...
    protected function buildPaidOrder(User $user, ShopMobileCheckout $row, string $paymentIntentId): Order
    {
        ...
        $order = Order::create([
            ...
            'instant_order_fee' => (float) ($row->instant_order_fee ?? 0),
    ...
    private function persistCheckoutPaymentRow(
        ...
        $row->update([
            ...
            'instant_order_fee' => (float) ($orderSummary['instant_order_fee'] ?? $row->instant_order_fee ?? 0),
            'total_amount' => $total,
            'wallet_amount_applied' => $walletApplied,
        ]);
