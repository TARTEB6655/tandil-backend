<x-areamanager-layout>
    ...
    <div class="mb-4 sm:mb-6">
        <h1 class="text-lg sm:text-xl font-medium text-gray-900">All Visits</h1>
        <p class="mt-1 text-xs sm:text-sm text-gray-500">View and manage all visits across all areas.</p>
    </div>

    <!-- Search Bar -->
    <div class="mb-4 sm:mb-6">
        <form action="{{ route('areamanager.visits.index') }}" method="GET" class="w-full">
            <div class="relative">
                ...
                @if($search ?? '')
                    <button type="button"
                            onclick="window.location.href='{{ route('areamanager.visits.index') }}'"
            ...
            <table class="w-full divide-y divide-gray-200 min-w-[640px]">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-3 sm:px-6 py-2 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden lg:table-cell">Area</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                <span class="px-2 py-1 text-xs font-medium rounded-full 
                                    ...
                                    @elseif($visit->status === 'approved') bg-green-100 text-green-800
                            ...
                            <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm font-medium">
                                <a href="{{ route('areamanager.visits.show', $visit->id) }}" 
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-3 sm:px-6 py-4 text-center text-xs sm:text-sm text-gray-500">No visits found</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
