                ...
                <div class="flex flex-col sm:flex-row sm:items-center gap-3 px-5 py-4 border-b border-gray-100 last:border-0 hover:bg-gray-50/50 transition-colors">
                    ...
                    <div class="flex items-center gap-1 sm:gap-2 flex-wrap">
                        @if($fileAvailable)
                            ...
                            <a href="{{ url(route('areamanager.generated-reports.download', ['id' => $r->id])) }}" download="area-manager-report-{{ $r->id }}.pdf" class="min-h-[44px] px-3 min-w-[44px] inline-flex items-center justify-center gap-1.5 rounded-lg border border-gray-200 bg-white text-gray-600 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-1" title="Download PDF" aria-label="Download PDF">
