                            ...
                            <td class="px-4 sm:px-6 py-4 text-right align-middle">
                                <div class="flex items-center justify-end gap-1.5 sm:gap-2 flex-shrink-0">
                                    @if($r->status === 'generated' && $r->file_path)
                                        <a href="{{ route('areamanager.generated-reports.download', ['id' => $r->id]) }}" class="inline-flex items-center justify-center w-10 h-10 rounded-lg border border-indigo-200 bg-indigo-50/80 text-indigo-700 hover:bg-indigo-100 hover:border-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1 transition-colors" title="Download PDF" aria-label="Download PDF">
