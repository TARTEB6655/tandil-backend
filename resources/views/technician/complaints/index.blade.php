<x-technician-layout>
    ...
    <div class="mb-4 sm:mb-6">
        ...
        <p class="mt-1 text-xs sm:text-sm text-gray-500">View complaints related to your visits.</p>
    </div>

    <!-- Search Bar -->
    <div class="mb-4 sm:mb-6">
        <form action="{{ route('technician.complaints.index') }}" method="GET" class="w-full">
            <div class="relative">
                ...
                @if($search ?? '')
                    <button type="button"
                            onclick="window.location.href='{{ route('technician.complaints.index') }}'"
