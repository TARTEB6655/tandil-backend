<x-technician-layout>
    ...
    <div class="mb-4 flex items-center justify-between">
        <a href="{{ route('technician.notifications.index') }}" class="text-sm text-indigo-600 hover:text-indigo-800">&larr; Back to notifications</a>
        <form action="{{ route('technician.notifications.destroy', $notification->id) }}" method="POST">
            @csrf
            @method('DELETE')
