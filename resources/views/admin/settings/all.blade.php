...
<x-admin-layout>
    <div class="flex flex-col lg:flex-row gap-6 lg:gap-8">
        ...
        <div class="mb-6 md:mb-8 flex items-center justify-between">
            <div>
                <a href="{{ route('admin.settings.index') }}" class="text-sm text-indigo-600 hover:text-indigo-700 font-medium mb-2 inline-flex items-center gap-1">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" /></svg>
                    Back to Settings
                </a>
                <h1 class="text-2xl font-semibold text-gray-900">All Settings</h1>
