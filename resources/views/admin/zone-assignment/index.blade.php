                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-700/50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Technicians</th>
                        ...
                        @forelse($areas as $area)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                    <a href="{{ route('admin.areas.edit', $area->id) }}" class="text-indigo-600 dark:text-indigo-400 hover:underline font-medium">Edit</a>
                                    <span class="mx-1 text-gray-300">|</span>
                                    <a href="{{ route('admin.areas.show', $area->id) }}" class="text-gray-600 dark:text-gray-400 hover:underline">View</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-700/50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Assigned zones</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">
                                    @if($sup->supervisedAreas->isEmpty())
                                        <span class="text-amber-600 dark:text-amber-400">None assigned</span>
                                    @else
