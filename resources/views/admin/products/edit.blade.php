<x-admin-layout>
    <div class="space-y-6">
        ...
        <form method="POST" action="{{ route('admin.products.update.post', $product) }}" enctype="multipart/form-data" id="productForm">
                @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="mb-4">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-4">For service/visit products. Shown on shop API and used as defaults on new orders.</p>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="estimated_arrival" name="estimated_arrival" value="{{ old('estimated_arrival', $product->estimated_arrival) }}"
                                       maxlength="255" placeholder="e.g. Within 2 hours"
                                       class="block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:text-gray-100">
                            ...
                            <div>
                                ...
                                <input type="text" id="job_duration" name="job_duration" value="{{ old('job_duration', $product->job_duration) }}"
                                       maxlength="255" placeholder="e.g. 45 minutes"
                                       class="block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:text-gray-100">
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div>
                            ...
                            <div>
                                <label for="type" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Product family (optional)</label>
                                <input type="text" id="type" name="type" value="{{ old('type', $product->type) }}" placeholder="e.g. Sheep, Accessories"
                                       class="block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:text-gray-100">
                            </div>
                            <div>
