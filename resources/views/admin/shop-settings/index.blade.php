    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    Shipping cost and tax % per category. Mobile admin API: <code class="text-xs bg-gray-100 dark:bg-gray-900 px-1 rounded">PUT /api/admin/settings/shop/category-shipping</code>
                </p>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                        <thead class="bg-gray-50 dark:bg-gray-700/50">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase w-48">Shipping cost ({{ $currency }})</th>
