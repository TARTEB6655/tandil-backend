<x-admin-layout>
    <div class="space-y-6"
         x-data="{
            title: @js(old('title', '')),
            badge: @js(old('badge_text', '')),
            button: @js(old('button_text', '')),
            previewUrl: null,
            setVideo(input) {
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Design the featured video card for the customer app. Max 30MB.</p>
            </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                <form method="POST" action="{{ route('admin.video-banners.store') }}" enctype="multipart/form-data" class="p-6 space-y-6" id="video-banner-form">
                    @csrf
                    ...
                    <div>
                        ...
                        <p class="mt-1.5 text-xs text-gray-500">MP4 recommended. Maximum <strong>30MB</strong>.</p>
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" x-model="title" placeholder="e.g. See Tandil in action"
                    ...
                    <div>
                        ...
                        <input type="text" name="badge_text" id="badge_text" x-model="badge" placeholder="e.g. Watch now"
                               class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="button_text" id="button_text" x-model="button" placeholder="e.g. Explore services"
                               class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            ...
            <div>
                ...
                <div class="relative aspect-[16/10] overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-700 bg-slate-900 shadow-lg">
                    ...
                    <div x-show="!previewUrl" class="absolute inset-0 flex items-center justify-center text-slate-400 text-sm px-6 text-center">
                        Upload a video to preview the banner card
                    </div>
