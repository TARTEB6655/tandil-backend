<x-admin-layout>
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-xl font-medium text-gray-900 dark:text-gray-100">Create Category</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Add a new product category with an optional image</p>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
            <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <!-- Image upload (left column on large screens) -->
                    <div class="lg:col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <div id="image-preview" class="aspect-square rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700/50 flex flex-col items-center justify-center text-center p-4 hover:border-indigo-400 dark:hover:border-indigo-500 transition-colors">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" 
                                      name="description" 
                                      rows="4"
                                      class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
