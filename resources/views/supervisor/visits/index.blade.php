<x-supervisor-layout>
    ...
    <div class="mb-4 sm:mb-6">
        <h1 class="text-lg sm:text-xl font-medium text-gray-900">Visits</h1>
        <p class="mt-1 text-xs sm:text-sm text-gray-500">Review and manage visits in your supervised areas.</p>
    </div>

    <!-- Search Bar -->
    <div class="mb-4 sm:mb-6">
        <form action="{{ route('supervisor.visits.index') }}" method="GET" class="w-full">
            <div class="relative">
                ...
                @if($search ?? '')
                    <button type="button"
                            onclick="window.location.href='{{ route('supervisor.visits.index') }}'"
