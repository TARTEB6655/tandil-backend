            ...
            >
                ...
                <div class="sidebar-scroll flex min-h-0 flex-1 flex-col overflow-y-auto overflow-x-hidden">
                    <nav class="flex-1 px-3 py-2">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('vendor.categories.index') }}" class="{{ $linkClass(request()->routeIs('vendor.categories.*')) }}">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('vendor.services.index') }}" class="{{ $linkClass(request()->routeIs('vendor.services.*')) }}">
                        ...
                        <div class="mt-4 border-t border-gray-200 pt-4">
                            ...
                            <div class="mb-2">
                                <a href="{{ route('vendor.notifications.index') }}" class="{{ $linkClass(request()->routeIs('vendor.notifications.*')) }}">
                            ...
                            <div class="mb-2">
                                <a href="{{ route('vendor.support-chat.index') }}" class="{{ $linkClass(request()->routeIs('vendor.support-chat.*')) }}">
                            ...
                            <div class="mb-2">
                                <a href="{{ route('vendor.help-support.index') }}" class="{{ $linkClass(request()->routeIs('vendor.help-support.*')) }}">
