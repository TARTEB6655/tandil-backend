@php
    ...
    $unreadNotifications = \App\Support\GlobalNotificationFilter::unreadForUser($user)->latest()->take(5)->get();
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2 sm:gap-3 lg:gap-5 flex-shrink-0">
                ...
                <div class="relative flex-shrink-0" x-data="{ open: false }">
                    ...
                    >
                        <svg class="header-action-icon" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        @if($unreadCount > 0)
                            <span class="pointer-events-none absolute right-2 top-2 h-2 w-2 rounded-full bg-red-500 ring-2 ring-white" aria-hidden="true"></span>
                        @endif
                    </button>
                ...
                <div class="relative flex-shrink-0" x-data="{ open: false }">
                    <button
                        @click="open = !open"
                        class="flex items-center gap-2 px-2 py-1.5 rounded-lg hover:bg-gray-100 transition-colors duration-200"
                    ...
                    >
                        ...
                        @else
                            <div class="h-8 w-8 flex items-center justify-center rounded-full text-white text-sm font-semibold shadow-sm flex-shrink-0" style="background: linear-gradient(to bottom right, #10b981, #059669);">
                    ...
                    >
                        ...
                        <a href="{{ route('vendor.profile.show') }}" class="flex items-center gap-3 px-5 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-150" @click.stop="open = false">
                            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                            <span class="font-medium">Business Profile</span>
                        </a>
                        <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 px-5 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-150" @click.stop="open = false">
                            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
