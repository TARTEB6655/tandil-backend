        ...
        <div>
            ...
            >
                ...
                <div class="flex-shrink-0 flex items-center justify-between px-3 sm:px-4 py-6 sm:py-8">
                    <a href="{{ route('technician.dashboard') }}" class="flex items-center flex-1 justify-center lg:justify-center">
                    ...
                    <nav class="px-3 py-2 flex-1">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('technician.dashboard') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('technician.dashboard') ? 'bg-gray-100 font-semibold' : '' }}">
                        ...
                        <!-- My Visits -->
                        <div class="mb-2">
                            <a href="{{ route('technician.visits.index') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('technician.visits.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('technician.reports.index') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('technician.reports.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('technician.complaints.index') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('technician.complaints.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Tips -->
                        <div class="mb-2">
                            <a href="{{ route('technician.tips.index') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('technician.tips.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Help & Support -->
                        <div class="mb-2">
                            <a href="{{ route('technician.help-support.index') }}"
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('technician.help-support.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('technician.notifications.index') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('technician.notifications.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
