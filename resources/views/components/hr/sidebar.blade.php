        ...
        <div>
            ...
            >
                ...
                <div class="flex-shrink-0 flex items-center justify-between px-3 sm:px-4 py-6 sm:py-8">
                    <a href="{{ route('hr.dashboard') }}" class="flex items-center flex-1 justify-center lg:justify-center">
                    ...
                    <nav class="px-3 py-2 flex-1">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('hr.dashboard') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('hr.dashboard') ? 'bg-gray-100 font-semibold' : '' }}">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('hr.employees.index') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('hr.employees.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('hr.leave-requests.index') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('hr.leave-requests.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('hr.visit-assignments.index') }}"
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('hr.visit-assignments.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                                </svg>
                                {{ __('admin.assign_visits') }}
                            </a>
                        </div>

                        <div class="mb-2">
                            <a href="{{ route('hr.reports.technician-monthly') }}"
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('hr.reports.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Help & Support -->
                        <div class="mb-2">
                            <a href="{{ route('hr.help-support.index') }}"
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('hr.help-support.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('hr.notifications.index') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('hr.notifications.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
