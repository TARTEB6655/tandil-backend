...
<head>
    ...
    <title>Tandil - Area Manager Dashboard</title>
    <script>
        // Force title update to prevent browser cache issues
        if (document.title !== 'Tandil - Area Manager Dashboard') {
            document.title = 'Tandil - Area Manager Dashboard';
        }
    </script>
