            ...
            >
                ...
                <div class="sidebar-scroll flex-1 flex flex-col overflow-y-auto overflow-x-hidden min-h-0">
                    <nav class="px-3 py-2" x-data="{ 
                        ...
                        <!-- USER MANAGEMENT -->
                        <div class="mb-2">
                            <button @click="userManagement = !userManagement" class="flex w-full items-center gap-2.5 rounded-md px-3 py-2 text-xs font-semibold text-gray-500 dark:text-gray-400 tracking-wide hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                        ...
                        <!-- SUBSCRIPTIONS -->
                        <div class="mb-2">
                            <button @click="subscriptions = !subscriptions" class="flex w-full items-center gap-2.5 rounded-md px-3 py-2 text-xs font-semibold text-gray-500 dark:text-gray-400 tracking-wide hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- OPERATIONS -->
                        <div class="mb-2">
                            <button @click="operations = !operations" class="flex w-full items-center gap-2.5 rounded-md px-3 py-2 text-xs font-semibold text-gray-500 dark:text-gray-400 tracking-wide hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- E-COMMERCE -->
                        <div class="mb-2">
                            <button @click="ecommerce = !ecommerce" class="flex w-full items-center gap-2.5 rounded-md px-3 py-2 text-xs font-semibold text-gray-500 dark:text-gray-400 tracking-wide hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <ul x-show="ecommerce" 
                                ...
                                <li style="padding-left: 0px;">
                                    <a href="{{ route('admin.wallet.index') }}"
                                       class="flex items-center gap-2.5 rounded-md pl-7 pr-3 py-1.5 text-sm font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-gray-100 transition-colors {{ request()->routeIs('admin.wallet.*') ? 'bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 font-semibold' : '' }}">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- COMMUNICATION -->
                        <div class="mb-2">
                            <button @click="communication = !communication" class="flex w-full items-center gap-2.5 rounded-md px-3 py-2 text-xs font-semibold text-gray-500 dark:text-gray-400 tracking-wide hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- MANAGEMENT -->
                        <div class="mb-2">
                            <button @click="management = !management" class="flex w-full items-center gap-2.5 rounded-md px-3 py-2 text-xs font-semibold text-gray-500 dark:text-gray-400 tracking-wide hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- SETTINGS -->
                        <div class="mb-2">
                            <button @click="settings = !settings" class="flex w-full items-center gap-2.5 rounded-md px-3 py-2 text-xs font-semibold text-gray-500 dark:text-gray-400 tracking-wide hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors {{ request()->routeIs('admin.settings.*') ? 'bg-gray-100 dark:bg-gray-800' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
