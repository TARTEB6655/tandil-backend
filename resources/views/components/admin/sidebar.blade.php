            ...
            >
                ...
                <div class="sidebar-scroll flex-1 flex flex-col overflow-y-auto overflow-x-hidden min-h-0">
                    <nav class="px-3 py-2" x-data="{ 
                        ...
                        ecommerce: {{ request()->routeIs('admin.products.*') || request()->routeIs('admin.orders.*') || request()->routeIs('admin.payments.*') || request()->routeIs('admin.categories.*') || request()->routeIs('admin.packages.*') ? 'true' : 'false' }},
                        ...
                        <div class="mb-2">
                            <a href="{{ route('admin.dashboard') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors {{ request()->routeIs('admin.dashboard') ? 'bg-gray-100 dark:bg-gray-800 font-semibold' : '' }}">
