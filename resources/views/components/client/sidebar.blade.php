                    ...
                    <nav class="px-3 py-2 flex-1">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('client.dashboard') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('client.dashboard') ? 'bg-gray-100 font-semibold' : '' }}">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('client.subscriptions.index') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('client.subscriptions.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('client.visits.index') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('client.visits.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('client.reports.index') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('client.reports.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('client.orders.index') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('client.orders.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('client.services.index') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('client.services.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('client.complaints.index') }}" 
                               class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('client.complaints.*') ? 'bg-gray-100 font-semibold' : '' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="pt-2 mt-2 border-t border-gray-200">
                            ...
                            <a href="{{ route('client.wallet.index') }}" class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 transition-colors {{ request()->routeIs('client.wallet.*') ? 'bg-gray-100 font-semibold' : '' }}">
