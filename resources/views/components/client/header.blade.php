        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2 sm:gap-3 lg:gap-5 flex-shrink-0">
                ...
                >
                    ...
                    @if($cartItemCount > 0)
                        <span
                            class="pointer-events-none absolute right-0.5 top-0.5 flex h-[15px] min-w-[15px] items-center justify-center rounded-full bg-indigo-600 px-0.5 text-[9px] font-bold leading-none text-white ring-[1.5px] ring-white tabular-nums"
                            aria-hidden="true"
                        >
                ...
                <div class="relative flex-shrink-0" x-data="{ open: false }">
                    ...
                    >
                        ...
                        <div class="hidden lg:flex items-center gap-1.5 min-w-0">
                            ...
                            <!-- Dropdown Arrow -->
                            <svg
                                class="header-action-icon text-gray-400 transition-transform duration-200"
                                width="18"
                                height="18"
