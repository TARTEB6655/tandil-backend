    ...
    <div class="mb-4 sm:mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
            <div>
                ...
                <p class="mt-1 text-xs sm:text-sm text-gray-500">Stay updated with your visit reminders, reports, and order updates.</p>
            </div>
            @if($unreadCount > 0)
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-0">
                                <div class="flex-1">
                                    ...
                                    @elseif(isset($data['subscription_id']))
                                        <p class="text-xs text-gray-500">Subscription ID: #{{ $data['subscription_id'] }}</p>
                                    @elseif(isset($data['order_id']))
                                        <p class="text-xs text-gray-500">Order ID: #{{ $data['order_id'] }}</p>
                                    @endif
