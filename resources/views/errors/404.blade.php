    ...
    <div class="min-h-screen flex flex-col items-center justify-center px-4 py-12">
        <div class="max-w-md w-full text-center">
            ...
            <div class="mb-8 flex justify-center">
                <img src="{{ asset('images/logo.png') }}" alt="{{ config('app.name', 'Tandil') }}" class="h-16 w-auto">
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <button onclick="window.history.back()" 
                        class="inline-flex items-center px-6 py-3 bg-white hover:bg-gray-50 text-gray-700 font-medium rounded-lg border border-gray-300 shadow-sm transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
