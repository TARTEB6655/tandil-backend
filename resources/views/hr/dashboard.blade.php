<x-hr-layout>
    ...
    <div class="mb-4 sm:mb-6 md:mb-8">
        <h2 class="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-3">Quick actions</h2>
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <a href="{{ route('hr.employees.create') }}" class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm hover:border-pink-200 hover:shadow-md transition flex flex-col items-center text-center gap-2">
                <div class="h-10 w-10 rounded-lg bg-pink-50 flex items-center justify-center text-pink-600">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" /></svg>
                </div>
                <span class="text-sm font-medium text-gray-900">Add employee</span>
            </a>
            <a href="{{ route('hr.leave-requests.index') }}" class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm hover:border-amber-200 hover:shadow-md transition flex flex-col items-center text-center gap-2">
            ...
            <a href="{{ route('hr.visit-assignments.index') }}" class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm hover:border-indigo-200 hover:shadow-md transition flex flex-col items-center text-center gap-2">
                ...
                <span class="text-sm font-medium text-gray-900">Assign visits</span>
            </a>
            <a href="{{ route('hr.reports.technician-monthly') }}" class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm hover:border-emerald-200 hover:shadow-md transition flex flex-col items-center text-center gap-2">
