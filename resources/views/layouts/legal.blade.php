...
<head>
    ...
    <style>
        .legal-page { font-family: Figtree, ui-sans-serif, system-ui, sans-serif; }
        .legal-prose h2 { font-size: 1.125rem; font-weight: 700; color: #0f172a; margin: 1.75rem 0 0.5rem; }
        .legal-prose p, .legal-prose li { color: #334155; line-height: 1.65; font-size: 1rem; }
